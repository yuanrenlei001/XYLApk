...
var Views = {
	tmpl: {
        ...
        detailed:'views/tmpl/mine/detailed.html:明细:#fff',
		...
		successOrder:'views/tmpl/mine/successOrder.html:确认订单:#f7f7f7',
		...
		becomeDetails:'views/tmpl/classification/becomeDetails.html:购买身份/补货:#f7f7f7',
