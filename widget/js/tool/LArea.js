...
window.LArea = (function() {
    ...
    MobileArea.prototype = {
        ...
        finish: function(e) {
            ...
            _self.close(e);
            dataSave('provinceCode',provinceCode);//省id
            dataSave('cityCode',cityCode);//市id
            dataSave('countyCode',countyCode);//区id
            dataSave('provinceText',provinceText);//省名称
            dataSave('cityText',cityText);//市名称
            dataSave('countyText',countyText);//区名称
        },
        close: function(e) {
            e.preventDefault();
            var _self = this;
